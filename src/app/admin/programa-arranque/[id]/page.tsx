    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          icon={<BanknotesIcon className="h-5 w-5 text-[#3E667D]" />}
        />
        <StatCard
                ...
                {Object.entries(summary.byTriggerType).map(([type, info]) => (
                  <div key={type} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-[#C8DDF2]" />
                ...
                .map(([type, info], idx) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-6 h-6 rounded-full bg-[#3E667D] text-white text-xs flex items-center justify-center font-bold">
                        {idx + 1}
                      </span>
