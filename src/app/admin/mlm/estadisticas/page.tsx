            ...
            {customerLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-2xl font-bold text-[#003B7A]">{formatNumber(customerStats.totalPoints)}</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  <p className="text-xs text-gray-600 mb-1">Puntos de Grupo</p>
                  <p className="text-2xl font-bold text-[#7AB82E]">{formatNumber(customerStats.groupPoints)}</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
